...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_DH] = LAYOUT_60_ansi_split_bs_rshift(
		KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_BSPC,
		...
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_M,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_NO,
		KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, MO(_F2), MO(_F3), KC_RCTL
	),

	[_DHA] = LAYOUT_60_ansi_split_bs_rshift(
		KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_BSPC,
		KC_TAB,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_LBRC, KC_RBRC, KC_BSLS,
		FN_BSPC, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    KC_K,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT, KC_ENT,
		KC_LSFT, KC_X,    KC_C,    KC_D,    KC_V,    KC_Z,    KC_M,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_NO,
		KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, MO(_F2), MO(_F3), KC_RCTL
	),

	[_DV] = LAYOUT_60_ansi_split_bs_rshift(
	...
	[_EL] = LAYOUT_60_ansi_split_bs_rshift(
	...
	[_F1] = LAYOUT_60_ansi_split_bs_rshift(
		...
		_______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, CTLBSPC, _______, _______, KC_UP,   _______, _______,
		_______, _______, _______,                   _______,                            KC_LEFT, KC_DOWN, KC_RGHT, _______
	),

	[_F2] = LAYOUT_60_ansi_split_bs_rshift(
		_______, EF_DEC,  EF_INC,  H1_DEC,  H1_INC,  H2_DEC,  H2_INC,  _______, _______, _______, _______, BR_DEC,  BR_INC,  RESET, TG_NKRO,
...
void backlight_indicators_user(void) {
	...
	if (layer_state_is(_F2)) {
		...
		backlight_effect_indicators_set_colors(42, hsPrimary);
		backlight_effect_indicators_set_colors(67, hsSecondary);
	}
