...
#define FW_BSPC LT(_F1W, KC_BSPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_CM] = LAYOUT_ansi(
		...
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  MT_SLSH, KC_RSFT, \
		KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_LALT, MO(_F2), MO(_F3), KC_RCTL \
	),
	...
	[_DH] = LAYOUT_ansi(
		...
		FN_BSPC, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT, KC_ENT, \
		KC_LSFT, KC_X,    KC_C,    KC_D,    KC_V,    KC_Z,    KC_K,    KC_H,    KC_COMM, KC_DOT,  MT_SLSH, KC_RSFT, \
		KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, MO(_F2), MO(_F3), KC_RCTL \
    ),

	[_DHW] = LAYOUT_iso_split_bs(
		...
		FW_BSPC, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    KC_RBRC, KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT, \
		KC_LSFT, KC_LSFT, KC_X,    KC_C,    KC_D,    KC_V,    KC_Z,    KC_EXLM, KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_RSFT, \
		KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, MO(_F2), MO(_F3), KC_RCTL \
    ),

	[_EL] = LAYOUT_ansi_split_lshift(
	...
	[_F1] = LAYOUT_ansi(
		...
		KC_CAPS, KC_F24,  _______, _______, _______, _______, KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_INS,  KC_DEL,  KC_NLCK, KC_PSCR, \
		_______, KC_LALT, _______, KC_LSFT, KC_LCTL, _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL,  KC_BSPC, _______, \
		_______, CTRL_Z,  CTRL_X,  CTRL_C,  CTRL_V,  _______, _______, _______, _______, _______, KC_UP,   _______, \
		_______, _______, _______,                   _______,                            KC_LEFT, KC_DOWN, KC_RGHT, _______ \
	),

	[_F1W] = LAYOUT_iso_split_bs(
		KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, KC_DEL, \
		KC_CAPS, KC_F24,  _______, _______, _______, _______, KC_NLCK, KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_INS,  KC_BSLS, KC_PSCR, \
		_______, KC_LALT, _______, KC_LSFT, KC_LCTL, _______, _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL,  KC_BSPC, \
		_______, CTRL_Z,  CTRL_X,  CTRL_C,  CTRL_V,  _______, _______, _______, _______, _______, _______, KC_UP,   _______, \
		_______, _______, _______,                   _______,                            KC_LEFT, KC_DOWN, KC_RGHT, _______ \
	),
	...
	[_F3] = LAYOUT_ansi(
		TO(_EL), QWERTY,  COLEMAK, COLEDH,  COLEDHW, _______, _______, KC_NLCK, KC_PSLS, KC_PAST, _______, _______, _______, _______, \
    ...
    [_F4] = LAYOUT_ansi(
        _______, UC_M_LN, UC_M_LN, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        ...
        _______, _______, _______, _______, _______, E_B,     _______, _______, _______, _______, _______, _______, \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
	...
	switch (keycode) {
		...
		case COLEDHW:
			if (record->event.pressed) {
				set_single_persistent_default_layer(_DHW);
			}
			return false;
        case GM_LED:
            if (record->event.pressed) {
